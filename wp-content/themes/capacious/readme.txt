...
3. In Front page displays choose 'A static page (select below)' and select page for homepage/frontpage
...
= 0.0.3 - August 25 2017
* Fixed prefixing  issues
* Fixed Custom page template issues
* Fixed all minor issues 

= 0.0.2 - August 05 2017
* Changed  Theme URI
* Fixed minior issues
...
License URI: http://www.gnu.org/licenses/gpl-2.0.html
Capacious WordPress Theme, Copyright 2017 Canyon Themes
Capacious is distributed under the terms of the GNU General Public License v2 or later
...
* Hover.css Version: 2.0.2 - Copyright Ian Lunn 2014. Generated with Sass. Licensed MIT,  http://www.opensource.org/licenses/mit-license.php

* OwlCarousel - v1.2.2.1 - Copyright (c) 2014 Owl,Modified work Copyright 2016 David Deutsch;Licensed MIT,  https://github.com/OwlCarousel2/OwlCarousel2/blob/develop/LICENSE


* Smooth Scroll - v3, 29 June 2007- Copyright (C) 2007 Free Software Foundation;   Licensed GNU GENERAL PUBLIC LICENSE,  https://github.com/cferdinandi/smooth-scroll/blob/master/LICENSE.md
...
#### Image used in screenshot ####
  ...
  * https://pixabay.com/en/chair-school-seating-classic-2424212/
